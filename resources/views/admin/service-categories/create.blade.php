        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="font-bold text-2xl text-gray-800 leading-tight">
                    <i class="fa-solid fa-plus text-indigo-600 mr-2"></i>{{ __('Add New Service Category') }}
                </h2>
                <p class="text-gray-500 text-sm mt-1">Create a parent category or a subcategory</p>
            </div>
    ...
    <div class="py-12 bg-gradient-to-b from-slate-50 to-white min-h-screen">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                <form method="POST" action="{{ route('admin.service-categories.store') }}" class="p-8">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            ...
                            <p class="text-gray-400 text-xs mt-1">Select a parent if this is a subcategory.</p>
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="color" name="color" id="color" value="{{ old('color', '#1e3a5f') }}"
                                    class="h-12 w-20 p-1 rounded-xl border border-gray-200 cursor-pointer">
                                <input type="text" id="color_text" value="{{ old('color', '#1e3a5f') }}"
                                    ...
                                    placeholder="#1E3A5F" oninput="document.getElementById('color').value = this.value">
                            </div>
