                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.testimonials.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="quote" name="quote" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="4" required>{{ old('quote') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="stars" class="block mt-1 w-full" type="number" name="stars" :value="old('stars', 5)" min="1" max="5" required />
