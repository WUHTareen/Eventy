    ...
    <div class="w-full">
        ...
        <form method="POST" action="{{ route('vendor.register.store') }}" class="space-y-4">
            ...
            <div class="pt-4 text-center grid grid-cols-2 gap-3 border-t border-white/5">
                ...
                <a href="{{ route('register') }}" class="py-2 border border-white/5 rounded-lg text-[9px] font-black text-white hover:text-indigo-400 uppercase tracking-widest transition-all bg-white/[0.01]">Client Signup</a>
            </div>
        </form>
    </div>
</x-guest-layout>
