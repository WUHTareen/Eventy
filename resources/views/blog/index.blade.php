...
@section('description', 'Tips, stories and updates from Eventy - Pakistan\'s First Hybrid Event, Travel & Hospitality Platform.')

@section('content')
<div class="py-16 bg-gradient-to-b from-slate-50 to-white min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        <div class="mb-10">
            <h1 class="text-4xl font-black text-[#0A3A7A] uppercase tracking-tight mb-2"><i class="fa-solid fa-newspaper mr-3"></i>Blog & Insights</h1>
            <p class="text-gray-500">Tips, stories and updates from Eventy</p>
        </div>
