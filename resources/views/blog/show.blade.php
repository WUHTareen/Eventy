<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2">
            <a href="{{ route('blog.index') }}" class="text-gray-500 hover:text-[#0A3A7A] transition">
                <i class="fa-solid fa-arrow-left mr-1"></i> Blog
            </a>
            <span class="text-gray-300">/</span>
            <span class="text-gray-700 font-semibold text-sm truncate">{{ Str::limit($post->title, 50) }}</span>
        </div>
    </x-slot>
